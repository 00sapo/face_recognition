...
% Vel (vel@LaTeXTemplates.com)
	...
	\renewcommand{\maketitlehookd}{%
		\begin{abstract}
			\noindent We tried to reimplement the algorithm
			described in [....]. We found that their results are
			reproducible only with large datasets and that with smaller dataset, the SVM models have very low precision results.
		\end{abstract}
	}
