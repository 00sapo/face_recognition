...
public:
    ...
    /**
         ...
         */
    Image4D(std::string name, cv::Mat& image, cv::Mat& depthMap, const cv::Mat& intrinsicCameraMatrix);
    ...
    /**
     * @brief getName get the name of the images (usually the originalli filename without extensions)
     * @return a string containing the image name
     */
    ...
    /**
    * @brief setName set the name of the images
    * @param name a string containing the new image name
    */
