...
\renewcommand{\maketitlehookd}{%
	\begin{abstract}
		...
		preprocessing tweaks and decision algorithms. Lastly, we state
		that the biggest contributions to the good training of the SVMs
		are given by the size and the noiseness of the dataset and the accuracy of the preprocessing steps.
	\end{abstract}
}
